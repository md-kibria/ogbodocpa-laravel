...
@section('title', 'Add Consultain')
@section('header', 'Add Consultain')
...
@section('content')
    ...
    <div class="w-full py-22">
        ...
        <form action="{{ route('admin.consultains.store') }}" class="border border-slate-700 w-2/3 mx-auto p-4 px-6 rounded-lg" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <label for="name" class="block font-light my-2 text-slate-100">
                ...
                <input type="name" id="name"
                    ...
                    placeholder="Enter name here" value="{{ old('name') }}" name="name" />
            ...
            <label for="email" class="block font-light my-2 text-slate-100">
                ...
                <input type="email" id="email"
                    ...
                    placeholder="Enter email here" value="{{ old('email') }}" name="email" />
            ...
            <label for="phone" class="block font-light my-2 text-slate-100">
                ...
                <input type="phone" id="phone"
                    ...
                    placeholder="Enter phone here" value="{{ old('phone') }}" name="phone" />
