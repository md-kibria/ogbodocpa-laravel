...
@section('content')
    ...
    <div class="overflow-x-auto w-full pt-6 pb-4">
        ...
        <table class="border-collapse border border-slate-500 my-2 w-full text-slate-300">
            ...
            <tbody>
                 @if (count($consultains) == 0)
                    <tr>
                        <td colspan="5" class="border border-slate-700 p-3 text-center">No items found.</td>
                    </tr>
                @endif
                @foreach ($consultains as $item)
                    <tr class="even:bg-slate-600">
                        ...
                        <td class="border border-slate-700 p-3 flex items-center justify-center">
                            <span
                                ...
                                <a href="{{ route('admin.consultains.show', $item->id) }}"
                                ...
                                <a href="{{ route('admin.consultains.edit', $item->id) }}"
                                ...
                                <form action="{{ route('admin.consultains.destroy', $item->id) }}"
        ...
        <div class="text-white">
            {{ $consultains->links('pagination::tailwind') }}
        </div>
