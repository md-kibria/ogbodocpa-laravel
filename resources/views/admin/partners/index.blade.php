...
@section('content')
    ...
    <div class="overflow-x-auto w-full pt-6 pb-4">
        <div class="flex">
            <p class="text-lg">All Partners</p>
        ...
        <table class="border-collapse border border-slate-500 my-2 w-full text-slate-300">
            <thead>
                <tr>
                    ...
                    <th class="border border-slate-600 bg-slate-700 p-3 text-sm">Logo</th>
                    <th class="border border-slate-600 bg-slate-700 p-3 text-sm">URL</th>
                ...
                @foreach ($partners as $item)
                    <tr class="even:bg-slate-600">
                        ...
                        <td class="border border-slate-700 p-3">
                            <img src="{{ asset('storage/' . $item->logo) }}" alt="" style="height: 30px">
                        </td>
                        <td class="border border-slate-700 p-3">{{ $item->url }}</td>
                        <td class="border border-slate-700 p-3">
