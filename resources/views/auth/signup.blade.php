            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation"
                        class="py-2 px-3 mt-1 block w-full rounded-md border @error('password_confirmation') border-red-300 @else border-gray-400 @enderror text-slate-700 shadow-sm focus:outline-0 focus:ring-slate-400 focus:border-slate-400 sm:text-sm"
